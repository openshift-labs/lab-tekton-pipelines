...
To bring up the web console, click on the **Console** tab. From the **Projects** list, click on your project and the click on the **Workloads** tab. Alternatively click on this [workloads](%console_url/console/k8s/cluster/projects/%project_namespace%/workloads)&nbsp;<span class="fas fa-window-restore"></span> link.
